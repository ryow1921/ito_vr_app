...
function itemfound(doc, sceneId, nextURL, problem, posi) {
    var quizContaner = doc.createElement('a-entity');
    ...
    var tresure = doc.createElement('a-sphere');
    tresure.setAttribute('id', 'tresure1');
    ...
    tresure1.addEventListener("click", function () {
        quizContaner.parentNode.removeChild(quizContaner);
        addResultcorrectPannel(doc, sceneId, nextURL);
    });
}